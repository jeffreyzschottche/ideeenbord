...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/brand-owner/email/verify/{id}/{hash}', function (Request $request, $id, $hash) {
        ...
        if (!hash_equals((string) $hash, sha1($owner->getEmailForVerification()))) {
            // Generic redirect for security reasons
    ...
    Route::post('/brand-owner/email/resend', function (Request $request) {
        ...
        return response()->json(['message' => 'Verification sent again']);
    ...
    Route::get('/email/verify/{id}/{hash}', function (Request $request, $id, $hash) {
        ...
        if (! URL::hasValidSignature($request)) {
            throw new AuthorizationException('Invalid or expired link.');
        }
    ...
    Route::get('/verify-email', function (Request $request) {
        ...
        return response()->json(['message' => 'Verification could not be confirmed.'], 422);
    ...
    Route::prefix('brands')->group(function () {
        ...
        Route::get('/{slug}', [BrandController::class, 'show']); // NEW
    ...
    Route::middleware(['auth:sanctum', IsAdmin::class])->prefix('admin')->group(function () {
        Route::post('/brands/owners/{id}/verify', function ($id) {
            ...
            return response()->json(['message' => 'BrandOwner successfully approved by admin.']);
        });
